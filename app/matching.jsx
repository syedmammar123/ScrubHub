...
//           if (presentBox !== -1) {
//             console.log("VALUE PRESENT at ", box.value);
//             console.log("UPDATING X,Y at index", answers.indexOf(presentBox));

//             translateValueX[answers.indexOf(presentBox)].value = withSpring(0);
//             translateValueY[answers.indexOf(presentBox)].value = withSpring(0);
//           }
//           runOnJS(updateAnswers)(index, box.value);
