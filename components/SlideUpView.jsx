...
import { Animated, Dimensions, TouchableOpacity, Text, StyleSheet, View, ActivityIndicator } from "react-native";
  ...
  return (
    ...
    >
        <SafeAreaView>
            ...
            <TouchableOpacity style={styles.buttonCircleStyle} onPress={() => onClose()}>
